...
| :--- | :--- | :--- |
| `-a` | `--agents <list>` | Target specific agents (comma-separated: `claude,opencode,codex,antigravity,copilot,droid,devin,warp`). `oz` is an alias for `warp` (desktop + Agent CLI + Oz). |
